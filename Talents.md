Talents are separated into "out of combat" and "in combat" talents just to make things easier to browse through, but these categories do not necessarily dictate entirely when a talent can be used or when it is relevant.
...
**Bean Hoarder** (1 RP)
Somehow, you seem to always have access to precious coffee beans to keep you and fellow Rangers sated, even when by all rights you should have run out. If you run out of coffee and must make some, roll a MIND check once per day to determine whether you have more on you.
**Caffeine Free** (1 RP)
...
**Born Ready** (2 RP)
Stringing a bow only takes one action. Characters who surprise attack you receive no bonus to their attack roll. At any time, you can use one Rush to immediately attack a character that has attacked you without any action loss.
...
**Strange Ways** (2 RP)
Your throwing knife is replaced by three shurikens or kunai. These use 1d8 for their attack roll.
**Swordmaster** (2 RP)
